...
tt$analgesie <- ifelse(tt$analgesie,"oui","non")
...
La faible différence est due au peu d'évaluations & surtout de réévaluations chez les patients ayant une douleur nulle. On peut évaluer ce fait pour la réévaluation ou l'analgésie (uniquement pour les `r length(na.omit(tt$en1))` patients ayant eu une évaluation initiale) :
